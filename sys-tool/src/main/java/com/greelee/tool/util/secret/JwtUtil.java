...
public class JwtUtil {
     ...
     * @return token
     */
    public static String createJwt(Map<String, Object> map, String userId, String audience, String issuer, long ttlMillis, String base64Security) {
         ...
         * 添加构成JWT的参数
         */
        JwtBuilder builder = Jwts.builder().setHeaderParam("typ", JwtConst.JWT_ID)
                /*
                 * 主要内容
                 */
                .setClaims(map)
